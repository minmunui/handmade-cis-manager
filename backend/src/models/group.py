...
class Group(Base):
    ...
    # 색상
    color : Mapped[Color] = mapped_column(SaEnum(Color, native_enum=False), nullable=False, default=Color.BASIC)
    # 설명
    description : Mapped[str | None] = mapped_column(String(128), unique=False, nullable=True)
    # 상태
